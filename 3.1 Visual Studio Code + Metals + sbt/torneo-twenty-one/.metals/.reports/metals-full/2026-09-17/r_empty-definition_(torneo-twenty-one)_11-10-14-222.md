error id: file:///C:/Users/AlumnoM_AI/Documents/ProyectosTajamar/parte3/3.1%20Visual%20Studio%20Code%20+%20Metals%20+%20sbt/torneo-twenty-one/src/main/scala/Main.scala:local3
...
while(i<puntuaciones.length){
    ...
    println(s"El jugador $j@@ugador con la puntuacion $puntuacion tiene el estado $estado")
    i=i+1
}
var totalJugadores=

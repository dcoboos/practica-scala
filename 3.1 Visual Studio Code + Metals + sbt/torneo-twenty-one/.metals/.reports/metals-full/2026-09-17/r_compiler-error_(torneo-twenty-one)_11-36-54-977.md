...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: ApplyImplicitView(method intArrayOps)
       tree position: line 101 of file:///C:/Users/AlumnoM_AI/Documents/ProyectosTajamar/parte3/3.1%20Visual%20Studio%20Code%20+%20Metals%20+%20sbt/torneo-twenty-one/src/main/scala/Main.scala
            tree tpe: scala.collection.mutable.ArrayOps.ofInt
              symbol: implicit method intArrayOps in object Predef
   symbol definition: implicit def intArrayOps(xs: Array[Int]): scala.collection.mutable.ArrayOps.ofInt (a MethodSymbol)
      symbol package: scala
       symbol owners: method intArrayOps -> object Predef
           call site: <none> in <none>

== Source file context for tree position ==

    98     println("HA HABIDO UN EMPATE ENTRE LAS MEJORES PUNTUACIONES")
    99 }
   100 
   101 puntuaciones.foreach
   102 _CURSOR_
   103 }
   104 

...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree(class Int)
       tree position: line 71 of file:///C:/Users/AlumnoM_AI/Documents/ProyectosTajamar/parte3/3.1%20Visual%20Studio%20Code%20+%20Metals%20+%20sbt/torneo-twenty-one/src/main/scala/Main.scala
            tree tpe: Int
...
== Source file context for tree position ==
    ...
    70 val totalValidas=puntuaciones.count(p)
    71 val t_CURSOR_otalBust=puntuaciones.count(p=>bust(p))
    72 
    73 println("--- Resumen de la ronda ---")
    74 println(s"Jugadores $totalJugadores")
...
val totalValidas=puntuaciones.count(p)
val t@@otalBust=puntuaciones.count(p=>bust(p))
